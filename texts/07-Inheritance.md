...
Существуют классы, в которых виртуальные функции не имеют реализации. Такие функции называются **число виртуальными**, а классы, в которых они находятся, - **абстрактыми**.

Нельзя создать экземпляр абстрактоного класса.
